...
public class UIManager : Manager_Base
{
    ...
    /// <summary>
    /// Manager_Base 1�ܰ� �ʱ�ȭ : �̱��� ���� �� ���� ���ε�
    /// </summary>
    public override bool Setup()
    {
        if (!ReferenceEquals(Instance, null) && Instance != null && Instance != this)
        {
            Debug.LogWarning("[UIManager] �ߺ� �ν��Ͻ��� �߰ߵǾ� �ı��մϴ�.");
            Destroy(gameObject);
            return false;
        }
    ...
    /// <summary>
    /// UI_Root�� Awake�� �� ȣ��Ǿ� UIManager�� ��ϵ˴ϴ�.
    /// </summary>
